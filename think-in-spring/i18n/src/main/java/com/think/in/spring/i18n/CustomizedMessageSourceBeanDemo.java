...
/**
 * Spring Boot 场景下自定义 {@link MessageSource} Bean 示例
 * @author xschen
 *
 * @see MessageSource
...
public class CustomizedMessageSourceBeanDemo {
    ...
    /**
     * Spring Boot中，Primary Configuration Sources（Classes）高于 *AutoConfiguration
     * @return
     */
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext applicationContext =
                new SpringApplicationBuilder(CustomizedMessageSourceBeanDemo.class) // 不作为Web启动
